...
class Bayutscraper:
    ...
    def extract_permit_number(self,text):
        ...
        # print(permit_number_match)
        if permit_number_match:
            print(permit_number_match.group)
    ...
    def parse_property_page(self, selector, response):
        data = {
            ...
            'bed_bath_size': {
                'bedrooms': self.extract_numeric_value(selector.xpath("//*[@aria-label='Beds']//*[contains(@class, 'fc2d1086')]/text()")),
                'bathrooms': self.extract_numeric_value(selector.xpath("//*[@aria-label='Baths']//*[contains(@class, 'fc2d1086')]/text()")),
